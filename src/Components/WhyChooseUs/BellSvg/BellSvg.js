...
import mainBell from "../../../images/MainBell6.svg";

// import { ReactComponent as SVG } from "../../../images/svg-gator2.svg";
// import mainBell from "../../../images/MainBell4.svg"
import { motion, useTransform, useMotionValue, animate } from "motion/react";

import AlarmLottie from "../../../images/AlarmLottie.webm";
import AlarmLottieMp4 from "../../../images/AlarmLottieMp4.mp4";
import AlarmLottieGif from "../../../images/AlarmLottieGif.gif";

const BellSvg = () => {
  // console.log(mainBell)
  return (
    <div>
      <video muted autoPlay loop width="100px" height="100px">
        <source src={AlarmLottie} type="video/webm"></source>
      </video>
      {/* <img src={AlarmLottieGif}></img> */}
    </div>
    // <div>
    //   <svg
    ...
    //       <g
    //         transform="matrix(1,-0.000003463707344053546,0.000003463707344053546,1,-0.00010737492993939668,0.0002223873307229951)"
    //         opacity="1"
    //         style={{ display: "block" }}
    //       >
    //         <g opacity="1" transform="matrix(1,0,0,1,64.06999969482422,56)">
    //           <path
    //             stroke-linecap="butt"
    ...
    //       </g>
    //       <g
    //         transform="matrix(0.9999999403953552,0.00024379222304560244,-0.00024379222304560244,0.9999999403953552,0.015715934336185455,-0.015601031482219696)"
    //         opacity="1"
    //         style={{ display: "block" }}
    //         // style="display: block;"
    //       >
    //         <g opacity="1" transform="matrix(1,0,0,1,64,94.5)">
    //           <path
    ...
    //         style={{ display: "block" }}
    //       >
    //         <g opacity="1" transform="matrix(1,0,0,1,57,48.5)">
    //           <path
    //             stroke-linecap="round"
    //             stroke-linejoin="miter"
    //             fill-opacity="0"
...
/* <div>
      <object type="image/svg+xml" data={bell}></object>
      <svg
        style={{
          // width: "100%",
          height: "100%",
