...
const Packages = () => {
  ...
  return (
    <div>
      <div className={styles.packageProcess}>
        <div className={`${styles.brixContainerDefault2} ${styles.wContainer}`}>
          {/* <div className="container-medium">
            <div className="page-vertical page-xhuge">
              <div className="margin-bottom margin-xhuge"> */}
          <div className={styles.mgBottom30}>
            <div className={styles.textCenter}>
              ...
              <div className={styles.headerParagraph}>
                <p
                  ...
                  ref={ref2}
                >
                  Whether you're just starting or scaling your business, we have
                  the right plan for you. Select a pricing plan that fits your
                  needs and get access to top-notch digital services.
                </p>
              </div>
            </div>
            {/* </div> */}
